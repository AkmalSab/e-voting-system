    ...
    <div style="border-radius: 25px;" class="login-box-body">
        ...
        <form action="verification.php" method="POST">
            <div class="form-group has-feedback">
                <input placeholder="Last 4-Digits of NRIC" maxlength="4" type="text" onkeypress="return onlyNumberKey(event)" class="form-control" id="voters_id" name="voters_id" required>                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="row">
